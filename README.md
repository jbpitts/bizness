This project was bootstrapped with [Typescript Create React App](https://github.com/Microsoft/TypeScript-React-Starter#typescript-react-starter) and [Create React App](https://github.com/facebookincubator/create-react-app).
